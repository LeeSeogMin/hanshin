...
const homeSummary = [
  ...
  {
    label: "범위",
    title: "평가·선례·보완·신설에 AI 시대 전략까지 한 묶음으로 봅니다.",
    body:
      "계열제 평가는 진단이고, 과거사례는 선례 검토이며, 계열제 보완은 설계, 전공신설은 포트폴리오 선택지이고, AI 시대 미래전략은 이들을 관통하는 큰 방향입니다. 다섯을 분리하되 같은 기준으로 봅니다."
  }
];
      ...
      <section className="home-summary-section" aria-labelledby="home-overview-title">
        ...
        <div className="home-flow-panel">
          <div>
            ...
            <h2 id="home-overview-title">홈은 다섯 메뉴의 상위 지도입니다.</h2>
            <p>
              이 프로젝트는 먼저 진단하고, 과거 실패 선례를 대조한 뒤 제도 보완과 전공신설을 비교하고, AI 시대 미래전략으로 큰 방향을 잡습니다.
